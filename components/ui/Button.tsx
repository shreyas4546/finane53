...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 focus:ring-primary-500 shadow-sm',
